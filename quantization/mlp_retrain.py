...
def simple_retrain_with_early_stopping(cfg):
    ...
    with tf.Graph().as_default():
        ...
        #model
        model = mlp_fixed('mlp', n_bits_dict, pre_trained_path, opt_name)
...
if __name__ == '__main__':
    ...
    cfg['batch_size'] = 50
    cfg['save_path'] = './results/mlp_fixed/params/'
    cfg['hist_path'] = './results/mlp_fixed/logs/'
    cfg['max_epoch'] = 300
    cfg['max_change'] = 3
    cfg['max_patience'] = 5
    cfg['decay_factor'] = 0.2
    cfg['pre_trained_path'] = './results/mlp_float/params/'
    cfg['n_bits_dict'] = {'kernel' : 2, 'bias' : 8}
